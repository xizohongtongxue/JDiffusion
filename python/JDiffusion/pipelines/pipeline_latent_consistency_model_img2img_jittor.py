# Copied some parts from Stanford University Team and The HuggingFace Team under Apache2.0 License
#
...
class LatentConsistencyModelImg2ImgPipeline(
    ...
    def prepare_latents(self, image, timestep, batch_size, num_images_per_prompt, dtype,seed):
        ...
        noise = randn_tensor(shape, seed,  dtype=dtype)
    ...
    def get_guidance_scale_embedding(self, w, embedding_dim=512, dtype=jt.float32):
        ...
        if embedding_dim % 2 == 1:  # zero pad
            emb = jt.nn.functional.pad(emb, (0, 1))
    ...
    def __call__(
        ...
        **kwargs,
        ...
        latents = self.prepare_latents(
            image, latent_timestep, batch_size, num_images_per_prompt, prompt_embeds.dtype, seed
        )
