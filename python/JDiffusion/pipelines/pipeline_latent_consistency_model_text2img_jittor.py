...
class LatentConsistencyModelPipeline(
    ...
    _callback_tensor_inputs = ["latents",
                               "denoised", "prompt_embeds", "w_embedding"]
    ...
    def __call__(
        ...
        **kwargs,
        ...
        self.check_inputs(prompt, height, width, callback_steps,
                          prompt_embeds, callback_on_step_end_tensor_inputs)
        ...
        if ip_adapter_image is not None:
            output_hidden_state = False if isinstance(
                self.unet.encoder_hid_proj, ImageProjection) else True
