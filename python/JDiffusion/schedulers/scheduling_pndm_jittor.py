# Copied some parts from Zhejiang University Team and The HuggingFace Team under Apache2.0 License
#
...
class PNDMScheduler(SchedulerMixin, ConfigMixin):
    ...
    def __init__(
        ...
        if trained_betas is not None:
            self.betas = jt.array(trained_betas)
        ...
        self.final_alpha_cumprod = jt.array(1.0) if set_alpha_to_one else self.alphas_cumprod[0]
